...
<script>//This creates a marker on the map with position at manchester location, assigns it to the map created earlier, gives it a title of "Manchester", and sets its animation to DROP which means the marker will drop onto the map when first loaded.
